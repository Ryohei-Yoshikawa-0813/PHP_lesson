<?php 
  ...
  if ($errors == null) {
      ...
      $url = "http://192.168.33.10/task8-2.php";
  }
  ...
  echo "
    ...
    <head>
      ...
      <link rel='stylesheet' href='hp_content_check.css'>
        ...
        <div class='main'>
          ...
          <div class='main_form wrapper'>
            <form method='post' action='$url'>
              ...
              <option value='null'>$inqitem</option>
              ...
              <div class='form_submit'>
                <button class='btn btn_main form_btn' type='submit' name='submit'>確認</button>
              </div>
            </form>
          </div>
